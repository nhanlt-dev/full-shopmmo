...
//follower
/* tooltipster-follower v0.1.5 */ !(function (a, b) {
  "function" == typeof define && define.amd
      ...
      instance: {
        ...
        __init: function (a) {
          ...
          return (
            b.__displayed,
            b.__helper,
            (b.__initialROS = a.option("repositionOnScroll")),
            (b.__instance = a),
            b.__latestMouseEvent,
            (b.__namespace =
              "tooltipster-follower-" + Math.round(1e6 * Math.random())),
            b.__openingTouchEnded,
            b.__pointerPosition,
            (b.__previousState = "closed"),
            b.__size,
            b.__options,
            b.__initialROS || b.__instance.option("repositionOnScroll", !0),
            b.__optionsFormat(),
            b.__instance._on("destroy." + b.__namespace, function () {
              b.__destroy();
            }),
            b.__instance._on("options." + b.__namespace, function () {
              b.__optionsFormat();
            ...
            b.__instance._on("start." + b.__namespace, function (a) {
              b.__instance._$origin.on(
                "mousemove." + b.__namespace,
                function (a) {
            ...
            b.__instance._one(
              "startend." + b.__namespace + " startcancel." + b.__namespace,
              function (a) {
                b.__instance._$origin.off("mousemove." + b.__namespace),
                  "startcancel" == a.type && (b.__latestMouseEvent = null);
              }
            ),
            b.__instance._on("state." + b.__namespace, function (a) {
              "closed" == a.state
        ...
        __close: function () {
          return (
            "object" == typeof this.__instance.content() &&
              null !== this.__instance.content() &&
              this.__instance.content().detach(),
            this.__instance._$tooltip.remove(),
            (this.__instance._$tooltip = null),
            a(a.tooltipster._env.window.document).off("." + this.__namespace),
        ...
        __create: function () {
          var b = this,
            c = a(
              '<div class="tooltipster-base tooltipster-follower"><div class="tooltipster-box"><div class="tooltipster-content"></div></div></div>'
            ),
            d = a(a.tooltipster._env.window.document);
          b.__options.minWidth &&
            c.css("min-width", b.__options.minWidth + "px"),
            b.__options.maxWidth &&
              c.css("max-width", b.__options.maxWidth + "px"),
            (b.__instance._$tooltip = c),
            (b.__displayed = !1),
            (b.__openingTouchEnded = !1),
            d.on("mousemove." + b.__namespace, function (a) {
          ...
          return (
            e.tap &&
              d.on(
                "touchend." + b.__namespace + " touchcancel." + b.__namespace,
                function (a) {
                  b.__openingTouchEnded = !0;
                }
              ),
            b.__instance._trigger("created"),
            b
          );
        },
        __destroy: function () {
        ...
        __follow: function (b) {
          if (
            (b
              ? (this.__latestMouseEvent = b)
              : this.__latestMouseEvent && (b = this.__latestMouseEvent),
            b)
          ) {
            this.__displayed = !0;
            var c = {},
            ...
            switch (
              ((this.__helper.geo.window.scroll = {
                left:
                  a.tooltipster._env.window.scrollX ||
                  a.tooltipster._env.window.document.documentElement.scrollLeft,
                top:
                  a.tooltipster._env.window.scrollY ||
                  a.tooltipster._env.window.document.documentElement.scrollTop,
              }),
              d)
            ) {
              case "top-left":
            ...
            if ("left-center" == d || "right-center" == d) {
              if ("right-center" == d)
                c.left < this.__helper.geo.window.scroll.left &&
                  (b.pageX - e[0] + this.__size.width <=
                  this.__helper.geo.window.scroll.left +
                    ...
                    : ((d = "top-right"),
                      (e[1] = e[0]),
                      (c = { left: 0, top: b.pageY - e[1] })));
              else if (
                c.left + this.__size.width >
                this.__helper.geo.window.scroll.left +
                  this.__helper.geo.window.size.width
              ) {
                var f = b.pageX - e[0] - this.__size.width;
                f >= 0
                  ? ((d = "right-center"), (e[0] = -e[0]), (c.left = f))
                  : ((d = "top-left"),
                    (e[1] = -e[0]),
                    (c = { left: b.pageX + e[0], top: b.pageY - e[1] }));
              }
              c.top + this.__size.height >
                ...
                (c.top =
                  ...
                  this.__helper.geo.window.size.height -
                  this.__size.height),
                c.top < this.__helper.geo.window.scroll.top &&
                  (c.top = this.__helper.geo.window.scroll.top),
                c.top + this.__size.height >
            ...
            if ("left-center" != d && "right-center" != d) {
              ...
              if (0 == d.indexOf("bottom"))
                c.top < this.__helper.geo.window.scroll.top &&
                  (c.top < 0 ||
                    (g < this.__helper.geo.window.size.height - g &&
                      b.pageY + e[1] + this.__size.height <=
                        this.__helper.geo.document.size.height)) &&
                  (c.top = b.pageY + e[1]);
              else {
            ...
            this.__helper.geo.origin.fixedLineage &&
              ((c.left -= this.__helper.geo.window.scroll.left),
              (c.top -= this.__helper.geo.window.scroll.top));
            var j = { coord: c };
            this.__instance._trigger({
              ...
              this.__instance._$tooltip
                .css({ left: j.coord.left, top: j.coord.top })
                .show();
        ...
        __reposition: function (b, c) {
          ...
          var h = f.free().measure(),
            i = { size: h.size };
          c.geo.origin.fixedLineage
            ? d.__instance._$tooltip.css("position", "fixed")
            : d.__instance._$tooltip.css("position", ""),
          ...
          return (
            d.__follow(j),
            d.__instance._$tooltip.appendTo(d.__instance.option("parent")),
            d.__instance._trigger({
              type: "repositioned",
              event: b,
