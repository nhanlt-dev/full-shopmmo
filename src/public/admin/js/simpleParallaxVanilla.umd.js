(function (o, r) {
  ...
  const i = new u(),
    a = (() => {
      ...
      for (; t === void 0; )
        (t =
          document.createElement("div").style[s[e]] !== void 0 ? s[e] : void 0),
          (e += 1);
      return t;
    })(),
    f = (s) =>
      s.tagName.toLowerCase() !== "img" && s.tagName.toLowerCase() !== "picture"
        ? !0
        : !(
            !s ||
            !s.complete ||
  ...
  class c {
    ...
    intersectionObserver() {
      const t = { root: null, threshold: this.buildThresholdList() };
  ...
  class d {
    ...
    init() {
      i.setViewportAll(this.customContainer),
        (n = [...this.elements.map((t) => new c(t, this.settings)), ...n]),
        h ||
          (this.proceedRequestAnimationFrame(),
