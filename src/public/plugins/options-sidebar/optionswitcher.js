        ...
        <div class="right-sidebar-container-2">
          <div class="slim-scroll-right-sidebar-2">
            ...
            <div class="right-sidebar-2-body" data-simplebar>
              <span class="right-sidebar-2-subtitle">Bố cục tiêu đề</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 ec-header-fixed-to btn-right-sidebar-2-active">Khoá</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 ec-header-static-to">Tĩnh</a>
              </div>

              <span class="right-sidebar-2-subtitle">Bố cục thanh bên</span>
              <div class="no-col-space">
                <select class="right-sidebar-2-select" id="sidebar-option-select">
                  <option value="ec-sidebar-fixed">Khoá Mặc định</option>
                  <option value="ec-sidebar-fixed-minified">Khoá Giảm thiểu</option>
                  <option value="ec-sidebar-fixed-offcanvas">Khoá Offcanvas</option>
                  <option value="ec-sidebar-static">Tĩnh Mặc định</option>
                  <option value="ec-sidebar-static-minified">Tĩnh Giảm thiểu</option>
                  <option value="ec-sidebar-static-offcanvas">Tĩnh Offcanvas</option>
                </select>
              </div>

              <span class="right-sidebar-2-subtitle">Nền tiêu đề</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 btn-right-sidebar-2-active ec-header-light-to">Sáng</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 ec-header-dark-to">Tối</a>
              </div>

              <span class="right-sidebar-2-subtitle">Nền điều hướng</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 btn-right-sidebar-2-active ec-sidebar-light-to">Sáng</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 ec-sidebar-dark-to">Tối</a>
              </div>

              <span class="right-sidebar-2-subtitle">Bố cục khoảng cách</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 btn-right-sidebar-2-active default-spacing-to">Mặc Định</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 compact-spacing-to">Nhỏ gọn</a>
              </div>
              <div class="d-flex justify-content-center">
                <div id="reset-options" style="width: auto; cursor: pointer" class="btn-right-sidebar-2 btn-reset">Đặt lại
                  cài đặt</div>
              </div>
            </div>
          </div>
