    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-12 col-lg-7">
                <?php
                $url = $_REQUEST["url"];
                $result = mysqli_query($link, "SELECT * FROM introduce where urlIntroduce like '%" . $url . "%'");
                if (mysqli_num_rows($result) <> 0) {
                    ...
                    while ($row = mysqli_fetch_object($result)) {
                        ...
                        echo "<div >
                            <h1 style='font-size: 24px; font-weight: bold;  margin-bottom: 15px; line-height: 35px;'> $titleIntroduce</h1>
