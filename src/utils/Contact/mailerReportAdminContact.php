                                                                                                    ...
                                                                                                    <div style="border: 0px solid transparent; padding: 5px 0px 5px 0px;">
                                                                                                        <div style="padding-right: 0px; padding-left: 0px;" align="center">
                                                                                                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                                                <tbody>
                                                                                                                    <tr style="line-height:0px">
                                                                                                                        <td style="padding-right: 0px;padding-left: 0px;" align="center"><img style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 612px; display: block;" title="bear looking at password" alt="bear looking at password" src="https://' . $_SERVER['SERVER_NAME'] . '/src/docs/images/common/Teamwork.jpg" width="612" border="0" align="middle"> </td>
                                                                                                                    </tr>
                                                                                                                </tbody>
                                                                                                            </table>
                                                                                                        </div>
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr style="vertical-align: top;" valign="top">
                                                                                                                    <td style="word-break: break-word; vertical-align: top; text-align: center; width: 100%; padding: 0px 0px 10px 0px;" width="100%" valign="top" align="center">
                                                                                                                        <h1 style="color: #03191e; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 40px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><strong>Có Một Khách Hàng Đang Cần Hỗ Trợ</strong></h1>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                                                    ...
                                                                                                                    <td style="padding-right: 10px; padding-left: 20px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif">
                                                                                                                        <div style="color: #848484; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 1.8; padding: 10px 10px 10px 20px;">
                                                                                                                            <div style="line-height: 1.8; font-size: 12px; color: #848484; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 22px;">
                                                                                                                                <p style="margin: 0; font-size: 14px; line-height: 1.8; word-break: break-word; text-align: center; mso-line-height-alt: 25px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 14px;">Có vẻ như khách hàng <b>'. $dataContact['userName'] .'</b> với số điện thoại là <b>'. $dataContact['userEmail'] .'</b>  và số điện thoại là <b>'. $dataContact['userPhoneNumber'] .'</b> đang cần liên hệ với bạn về vấn đề <b>'. $contactType .'</b> với phản hồi <b>'. $dataContact['messageReport'] .'</b>. Hãy phản hồi họ sớm nhất có thể nhé.</span></p>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
