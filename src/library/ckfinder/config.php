...
$config['authentication'] = function () {
    // Trả về true để bật trình duyệt file cho tất cả người dùng
    return true;

    // Hoặc, triển khai logic xác thực của riêng bạn
    // Ví dụ: return isset($_SESSION['user_logged_in']) && $_SESSION['user_logged_in'] === true;
};

/*============================ License Key ============================================*/
// https://ckeditor.com/docs/ckfinder/ckfinder3-php/configuration.html#configuration_options_licenseKey

$config['licenseName'] = 'quangbathuonghieu.com.vn';
$config['licenseKey']  = '7FTFDUBJPAX8WQRH6X5SWUSYLD7M5';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/src/library/ckfinder/userfiles/',
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
