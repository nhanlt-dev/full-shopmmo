<?php
include('src/handlers/pagination/client/paginationPages.php');
$p = new pager;
$limit = 6;
$start = $p->findStart($limit);
$count = @mysqli_num_rows(mysqli_query($link, "SELECT * FROM pages"));
                ...
                <div class="col-12">
                    ...
                    <div class="flat-animate-tab">
                        <div class="tab-content">
                            <?php
                            $pagesQuery = mysqli_query($link, "SELECT * FROM pages ORDER BY id DESC LIMIT $start, $limit");
