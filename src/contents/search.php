<?php
include('src/handlers/pagination/client/paginationSearch.php');
...
$count = @mysqli_num_rows(mysqli_query($link, "SELECT * FROM pages Where pageName Like '%$query%'"));
            ...
            <div class="row">
                <div class="col-12">
                    <div class="box-title">
                        ...
                        <div class="right">
                            ...
                            <div class="nice-select select-filter list-sort" tabindex="0">
                                <span class="current">Sắp Xếp Bởi (Mặc Định)</span>
                                <ul class="list">
                                    <li data-value="default" class="option selected">Sắp Xếp Bởi (Mặc Định)</li>
                    ...
                    <div class="flat-animate-tab">
                        <h6>Bạn tìm đc <?= $count ?> doanh nghiệp với từ khoá " <?= $query ?> "</h6>
                        <div class="tab-content">
                            <?php
                            $pagesQuery = mysqli_query($link, "SELECT * FROM pages  Where pageName Like '%$query%' ORDER BY id DESC LIMIT $start, $limit");
                    ...
                    <div class="wrap-pagination">
                        <p class="text-1">Hiển thị <?= ($start + 1) . '-' . min($start + $limit, $count) ?> của <?= $count ?> kết quả.</p>
                        <ul class="wg-pagination">
                            <?= $p->pageList($currentPage, $query, $pages); ?>
                        </ul>
                    </div>
                </div>
            </div>
