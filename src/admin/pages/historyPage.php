                ...
                <div class="main-content-inner style-3">
                    <div class="widget-box-2 wd-listing">
                        <div class="d-flex jcsb">
                            <h3 class="title">Lịch Sử Thương Hiệu</h3>
                            <div class="d-flex jcsb">
                                <?php if ($_SESSION['userData']['role'] == 3) { ?>
                                    <div class="box mr2rem">
                                        <a href="javascript:void(0);" class="whitecolor tf-btn bg-color-primary pd-10 " onclick="showConfirmAlert('Bạn có chắc chắn muốn xóa toàn bộ lịch sử này?', 'Admin/deleteall/pages/historypage/thuong_hieu/');">
                                    ...
                                    <table id="responsive-data-table" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $historyQuery = mysqli_query($link, "SELECT h.*, u.userName FROM histories AS h
                                                                                                   ...
                                                                                                   Where h.details LIKE '%thương hiệu%'
                                                                                                   ORDER BY id DESC ");
                                                            ...
                                                            <td>
                                                                <ul class="list-action">
                                                                    <li class="d-flex jcsa">
                                                                        <a href="javascript:void(0);" class="remove-file item" onclick="showConfirmAlert('Bạn có chắc chắn muốn xóa lịch sử này?', 'Admin/deletehistory/pages/historypage/<?= $histories['idHistory'] ?>/');">
