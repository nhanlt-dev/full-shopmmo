                ...
                <div class="main-content-inner style-3">
                    <div class="widget-box-2 wd-listing">
                        <div class="d-flex jcsb">
                            <h3 class="title">Lịch Sử Hệ Thống</h3>
                            <div class="d-flex jcsb">
                                <?php if ($_SESSION['userData']['role'] == 3) { ?>
                                    <div class="box mr2rem">
                                        <a href="javascript:void(0);" class="whitecolor tf-btn bg-color-primary pd-10 " onclick="showConfirmAlert('Bạn có chắc chắn muốn xóa toàn bộ lịch sử này?', 'Admin/deleteall/configuration/historysystem/he_thong/');">
                                            <i class="fa-solid fa-delete-right"></i> Xoá Toàn Bộ
                                        </a>
                                    </div>
                                <?php } ?>
                                <div class="box">
                                    <a href="Admin/configuration/" class="whitecolor tf-btn bg-color-primary pd-10"><i class="fa-duotone fa-regular fa-list"></i> Chỉnh Sửa Hệ Thống</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            if (mysqli_num_rows($historyQuery) > 0) {
                                                ...
                                                while ($rowHistory = mysqli_fetch_object($historyQuery)) {
                                                    ...
                                                    $sttHistory++;
                                                    $dataPages[] = compact('sttHistory', 'idHistory', 'userName', 'action', 'details', 'ipAddress', 'userAgent', 'formattedDate');
                                                }
                                                foreach ($dataPages as $page) { ?>
                                                    <tr class="datarow">
                                                        ...
                                                        <td>
                                                            <div><?= $page['formattedDate'] ?></div>
                                                        </td>
                                                        <?php if ($_SESSION['userData']['role'] == 3) { ?>
                                                            <td>
                                                                <ul class="list-action">
                                                                    <li class="d-flex jcsa">
                                                                        <a href="javascript:void(0);" class="remove-file item" onclick="showConfirmAlert('Bạn có chắc chắn muốn xóa lịch sử này?', 'Admin/deletehistory/configuration/historysystem/<?= $idHistory ?>/');">
                    ...
                    <?php include('src/utils/Footer/footerDashboard.php') ?>
                </div>
