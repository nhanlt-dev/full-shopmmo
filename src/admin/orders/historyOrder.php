                            ...
                            <div class="d-flex jcsb">
                                <?php if ($_SESSION['userData']['role'] == 3) { ?>
                                    <div class="box mr2rem">
                                        <a href="javascript:void(0);" class="whitecolor tf-btn bg-color-primary pd-10 " onclick="showConfirmAlert('Bạn có chắc chắn muốn xóa toàn bộ lịch sử này?', 'Admin/deleteall/orders/historyorder/don_hang/');">
                                                            ...
                                                            <td>
                                                                <ul class="list-action">
                                                                    <li class="d-flex jcsa">
                                                                        <a href="javascript:void(0);" class="remove-file item" onclick="showConfirmAlert('Bạn có chắc chắn muốn xóa lịch sử này?', 'Admin/deletehistory/orders/historyorder/<?= $histories['idHistory'] ?>/');">
