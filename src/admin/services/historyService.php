                ...
                <div class="main-content-inner style-3">
                    <div class="widget-box-2 wd-listing">
                        <div class="d-flex jcsb">
                            <h3 class="title">Lịch Sử Dịch Vụ</h3>
                            <div class="d-flex jcsb">
                                <?php if ($_SESSION['userData']['role'] == 3) { ?>
                                    <div class="box mr2rem">
                                        <a href="javascript:void(0);" class="whitecolor tf-btn bg-color-primary pd-10 " onclick="showConfirmAlert('Bạn có chắc chắn muốn xóa toàn bộ lịch sử này?', 'Admin/deleteall/services/historyservice/dich_vu/');">
                                            <i class="fa-solid fa-delete-right"></i> Xoá Toàn Bộ
                                        </a>
                                    </div>
                                <?php } ?>
                                <div class="box">
                                    <a href="Admin/services/listservice/" class="whitecolor tf-btn bg-color-primary pd-10"><i class="fa-duotone fa-regular fa-list"></i> Danh Sách Tin Tức</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                                            ...
                                                            <td>
                                                                <ul class="list-action">
                                                                    <li class="d-flex jcsa">
                                                                        <a href="javascript:void(0);" class="remove-file item" onclick="showConfirmAlert('Bạn có chắc chắn muốn xóa lịch sử này?', 'Admin/deletehistory/services/historyservice/<?= $histories['idHistory'] ?>/');">
